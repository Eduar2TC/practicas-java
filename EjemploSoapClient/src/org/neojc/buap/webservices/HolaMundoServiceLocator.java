...
public class HolaMundoServiceLocator extends org.apache.axis.client.Service implements org.neojc.buap.webservices.HolaMundoService {
    ...
    private java.lang.String HolaMundo_address = "http://localhost:8005/EjemploSoap/services/HolaMundo";
    ...
    public org.neojc.buap.webservices.HolaMundo getHolaMundo(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.neojc.buap.webservices.HolaMundoSoapBindingStub _stub = new org.neojc.buap.webservices.HolaMundoSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.neojc.buap.webservices.HolaMundo.class.isAssignableFrom(serviceEndpointInterface)) {
                org.neojc.buap.webservices.HolaMundoSoapBindingStub _stub = new org.neojc.buap.webservices.HolaMundoSoapBindingStub(new java.net.URL(HolaMundo_address), this);
                _stub.setPortName(getHolaMundoWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.buap.neojc.org", "HolaMundoService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.buap.neojc.org", "HolaMundo"));
        }
