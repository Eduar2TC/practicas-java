			...
			public void widgetSelected(SelectionEvent e) {
				...
				switch(Operacion) {
					case "+": {	
						...
						resultado = operacionesSimples.suma(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
					}
					case "-": {
						//segundoOperador = Float.parseFloat(textoPantalla.getText().substring(tamanioPrimerOperador.length()-1));
						segundoOperador = Float.parseFloat(StringUtils.substringAfter(textoPantalla.getText(),"-"));
						resultado = operacionesSimples.resta(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
					}
					case "*": {
						//segundoOperador = Float.parseFloat(textoPantalla.getText().substring(tamanioPrimerOperador.length()-1));
						segundoOperador = Float.parseFloat(StringUtils.substringAfter(textoPantalla.getText(),"*"));
						resultado = operacionesSimples.multiplicacion(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
					}
					case "/": {
						//segundoOperador = Float.parseFloat(textoPantalla.getText().substring(tamanioPrimerOperador.length()-1));
						segundoOperador = Float.parseFloat(StringUtils.substringAfter(textoPantalla.getText(),"/"));
						resultado = operacionesSimples.division(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
					}
					case "mod":{
						//segundoOperador = Float.parseFloat(textoPantalla.getText().substring(tamanioPrimerOperador.length()-1));
						segundoOperador = Float.parseFloat(StringUtils.substringAfter(textoPantalla.getText(),"%"));
						resultado = OpComplejas.Modulo(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
						}
					case "x^n": {
						//segundoOperador = Float.parseFloat(textoPantalla.getText().substring(tamanioPrimerOperador.length()-1));
						segundoOperador = Float.parseFloat(StringUtils.substringAfter(textoPantalla.getText()," ^ "));
						resultado = OpComplejas.aLaN(primerOperador, segundoOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);	
						break;
					}
					case "x^2":{
						resultado = OpComplejas.alCuadrado(primerOperador);
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);							
						break;
					}
					case "sqrt":{
						resultado = OpComplejas.raizCudrada(Float.parseFloat(textoPantalla.getText().replace("sqrt(", "")));
						textoPantalla.setText(" )");
						resultadoTotal = String.format("%.2f", resultado);
						textoPantalla.setText(resultadoTotal);
						break;
					...
					case "OperacionPlus":{
						OpComplejas opComp = new OpComplejas();
						try {
							Object resultadoParcial =  opComp.CalculaDesdeCadena(textoPantalla.getText());
							//resultadoTotal = String.format("%d", resultadoParcial);
							textoPantalla.setText(resultadoParcial.toString());	
