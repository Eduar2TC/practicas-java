...
public class imagenVisor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public imagenVisor(BufferedImage imagenProcesada) {   //paramtero : objeto imagen resultante de ImageOperator
		this.imagenResultado = imagenProcesada;
		...
		contenidoImagen.setHorizontalAlignment(SwingConstants.CENTER);
				...
				if(respuesta == JFileChooser.APPROVE_OPTION) {
					try {
						...
						if(!filePath.endsWith(".png")) {
						    ...
						    ImageIO.write(imagenResultado, "png" , archivoConExtension.getAbsoluteFile());
						    JOptionPane.showMessageDialog(null," Imagen guardado ");
						}
