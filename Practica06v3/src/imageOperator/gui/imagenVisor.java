...
public class imagenVisor extends JFrame {
	...
	private int chunkRows; //determina el número de filas de la matriz de bloques.
	private int chunkCols; //determina el número de columnas de la matriz de bloques.
	...
	public imagenVisor(ImageOperator imgR) {   //paramtero : objeto imagen resultante de ImageOperator
		...
		ImageIcon muestraImg = new ImageIcon(imagenResultado);  //cambiar
		contenidoImagen.setIcon(muestraImg);
		
		contenidoImagen.revalidate(); 
		contenidoImagen.repaint();
